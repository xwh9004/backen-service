package com.example.springsecurity.cloud.oauth2.server.config;

import com.example.springsecurity.cloud.oauth2.server.custom.CustomTokenEnhancer;
...
public class OAuth2ServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    protected JwtAccessTokenConverter jwtTokenEnhancer() {
        KeyStoreKeyFactory keyStoreKeyFactory = new KeyStoreKeyFactory(new ClassPathResource("server.keystore"), "123456".toCharArray());
        JwtAccessTokenConverter converter = new JwtAccessTokenConverter();
        converter.setKeyPair(keyStoreKeyFactory.getKeyPair("serverkey"));
        return converter;
    }
